    ...
    while converged == False :
        ...
        for centroid in range(k):
            ...
            #If the centroid contains data, take the mean value of the data and find the new centroid location
                ...
                #In this case we are using the median values to update the centroid
                updated[centroid] = np.median(dataCentroid, axis=0)
...
for k_val in range(len(k_vals)):
    ...
    plt.savefig(path+'/Manhattan/Kmeans_result'+str(k_vals[k_val])+'.jpeg')
